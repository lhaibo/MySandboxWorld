...
{
/// <summary>
/// Contains methods and properties related to event center and event types in the Unity application.
/// </summary>
public static class EventCenterUtil {
    ...
    /// <summary>
    /// Initializes the Unity Editor related components of the EventCenterUtil.
    ...
    /// <summary>
    /// Initializes the EventCenterUtil class at runtime before the loading of any scene.
    ...
    static List<Type> InitializeAllBuses() {
        ...
        var typedef = typeof(EventCenter<>);
        foreach (var eventType in EventTypes) {
            var busType = typedef.MakeGenericType(eventType);
            eventBusTypes.Add(busType);
            Debug.Log($"Initialized EventCenter<{eventType.Name}>");
        }
